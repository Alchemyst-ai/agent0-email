...
export default function AiRepliesTab({
	...
	return (
		<div className="bg-gray-90 rounded-lg bordr border-gray-800">
			<h2 className="flex gap-2 text-lg font-semibold text-white items-center mb-3"> <Bot className=""/> AI Reply Settings</h2>
			
			<div className="space-y-4">
				<div>
					<label className="block text-sm font-medium text-gray-200 mb-2 pl-1">Custom Reply</label>
					<textarea
						className="w-full border border-gray-700 rounded-lg p-3 bg-gray-900/80 text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
						rows={3}
