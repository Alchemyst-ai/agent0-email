			...
			<div className="flex-1 overflow-y-auto p-4 space-y-4 ">
				...
				<div>
					...
					<textarea
						...
						className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none text-slate-900 placeholder-slate-500"
						rows={3}
					/>
				</div>
				...
				<div>
					...
					<input
						...
						className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 text-slate-900 placeholder-slate-500"
					/>
				</div>
				...
				<div className="flex gap-2 pt-4">
					<Button
						...
						disabled={loading}
						className="flex items-center gap-2 px-4 py-2 rounded-lg  transition-colors disabled:opacity-50 shadow-sm"
					>
						{loading ? (
